...
/** Tankbuch-Eintrag: nur Spritverbrauch (km oder Betriebsstunden, Liter, Preis). */
...
/** @deprecated Legacy blob – migrated into [VehicleEngineSpecs], [VehicleCarbIgnitionSpecs], [VehicleDrivetrainSpecs]. */
