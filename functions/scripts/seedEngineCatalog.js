...
const { seedEngineCatalog, defaultCatalogPath } = require("../lib/engineCatalogSeed");
...
async function main() {
  ...
  console.log(`Seeding engine catalog from ${catalogPath}`);
  const result = await seedEngineCatalog(db, {
    catalogPath,
